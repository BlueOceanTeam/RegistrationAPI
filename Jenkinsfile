node {
	...
	rtMaven.run pom: 'pom.xml', goals: '-Dsonar.login=admin -Dsonar.password=admin -Dsonar.tests=src/test/java -Dsonar.sources=src/main/java clean clean sonar:sonar -Dsonar.host.url=http://13.93.165.125:9000/'
